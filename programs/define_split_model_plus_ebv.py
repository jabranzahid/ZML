...
def define_split_model_plus_ebv(split, l1 = 0, l2 = 0):
    ...
    for i in range(split.n_filters):
        for j in range(split.n_chunks):
            ...
            inputs.append(input)
            output = Dense(128, kernel_regularizer=regularizers.l1_l2(l1=l1, l2=l2),
    ...
    #final_layers = Dropout(0.3)(final_layers)
    final_layers = Dense(11, activation = 'linear', name="Output_layer")(final_layers)
